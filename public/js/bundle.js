...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibG9naWNhbGJyYWlucy1mdWxsc3RhY2siLCJhIjoiY2s5c2V1ZTNyMTRpYjN0cXgyY2N3eTZ3YyJ9.aEMhb55AuDQYjMrFCc637Q';
  ...
  locations.forEach(function (location) {
    ...
    var el = document.createElement('div'); // Add Marker
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day: ".concat(location.day, ": ").concat(location.description, "</p>")).addTo(map); // Extend the map bounds to include the current location
